...
- Timestamp: `2022-06-11 12:41`
- Build ID: `aaa786cb-b6a2-462a-864a-b5919ab03720`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/aaa786cb-b6a2-462a-864a-b5919ab03720.git
$ cd aaa786cb-b6a2-462a-864a-b5919ab03720
```
